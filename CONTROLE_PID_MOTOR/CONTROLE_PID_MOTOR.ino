/*  ---------------------------------------------
  ...
  Em: Abril de 2023
  -----------------------------------------------
  Adaptado: Francisco Paiva da Silva Neto
  Em: Março de 2024
  -----------------------------------------------*/
...
static float erro_prev = 0;                            // Variavel responsavel por calcular o erro anterior para a acao derivativa
...
void loop() {
  ...
  static float controle = acaoP + acaoI + acaoD;        // Calcula o Sinal de Controle (a partir das ações)
